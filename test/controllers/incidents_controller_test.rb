...
class IncidentsControllerTest < ActionController::TestCase
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post :create, incident: { address: @incident.address, date: @incident.date, latitude: @incident.latitude, longitude: @incident.longitude, type: @incident.type }
    end
  ...
  test "should update incident" do
    patch :update, id: @incident, incident: { address: @incident.address, date: @incident.date, latitude: @incident.latitude, longitude: @incident.longitude, type: @incident.type }
    assert_redirected_to incident_path(assigns(:incident))
  end
